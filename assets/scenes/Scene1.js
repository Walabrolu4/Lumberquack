...
class Scene1 extends Phaser.Scene 
{
	...
	{	
		...
		this.progressBarFrame = this.add.sprite(110 , 80 ,"textures" , "TimeToHitBarFrame");
		...
		this.add.text(16,90,"LEFT and RIGHT \narrows to chop \navoid branches" , {fontSize: '20px' , fill:'#000'});
	...
	update() 
	{
		...
		else
		{
			...
			this.gameOverText = this.add.text(400 , 300 , "GAME OVER!!! 'DOWN' to restrart",{fontSize:'35px' , fill:'#020'});
